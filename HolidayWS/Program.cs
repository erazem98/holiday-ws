...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Holiday Web Service",
        Version = "v1",
        Description = "The API is meant to query public holidays in Slovenia. Years which are supported are from (and including) 1919 to 2400."
    });
